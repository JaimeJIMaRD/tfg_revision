    ...
    function activar(puesto) {
        ...
        if(otrosActores.length===0){
            ...
            otrosActores.forEach(function(actor) {
                ...
                if (actor.actor_id){
                    if(!actor.contexto){
                        slide.innerHTML = '<a href="{{ route('actor.show', $actor->id) }}"><p>' + actor.nombre_actor + '</p></a>';
                    } else{
                        slide.innerHTML = `
                        <a href="{{ route('actor.show', $actor->id) }}">
                          <div class="flex">
                            ...
                            <div class="relative group select-none cursor-default">
                              <p
                                class="absolute bg-white aparecer2 text-black -bottom-full -left-40 mb-full rounded-md px-2 py-1 shadow-xl w-40"
                              >
                            `+ actor.contexto + `
                              </p>
